...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.listBaseInfo = QtWidgets.QListWidget(Form)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.listBaseInfo.sizePolicy().hasHeightForWidth())
        self.listBaseInfo.setSizePolicy(sizePolicy)
        self.listBaseInfo.setMinimumSize(QtCore.QSize(200, 180))
        self.listBaseInfo.setMaximumSize(QtCore.QSize(200, 180))
        self.listBaseInfo.setObjectName("listBaseInfo")
        self.verticalLayout_2.addWidget(self.listBaseInfo)
        ...
        self.listImportant.setMinimumSize(QtCore.QSize(200, 0))
