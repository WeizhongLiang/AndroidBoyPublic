...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btADBWifi.sizePolicy().hasHeightForWidth())
        self.btADBWifi.setSizePolicy(sizePolicy)
        self.btADBWifi.setMinimumSize(QtCore.QSize(0, 24))
        self.btADBWifi.setMaximumSize(QtCore.QSize(16777215, 24))
        self.btADBWifi.setObjectName("btADBWifi")
        self.layoutDevices.addWidget(self.btADBWifi)
